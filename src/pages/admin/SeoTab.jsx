...
const ROUTES = [
  ...
  { path: '/products/canopy-tent-10x10', label: '10×10 Canopy' },
  { path: '/products/canopy-tent-10x15', label: '10×15 Canopy' },
  { path: '/products/canopy-tent-10x20', label: '10×20 Canopy' },
