...
export const CITY_DETAIL = {
  ...
  'nashville': {
    ...
    faqs: [
      ...
      { q: 'Which displays work best inside the Music City Center?', a: 'Fabric backdrops, retractable banner stands and printed table covers work best inside the Music City Center, the indoor booth kit for most exhibitors: they are portable, set up tool-free and need no installation labor. Use a step & repeat or tension-fabric wall for the booth back, retractable banners at the aisle, and a fitted cover on the demo table.' },
  ...
  'indianapolis': {
    ...
    productSections: [
      ...
      },
      {
        ...
        body: 'Indianapolis packs its outdoor season into a few busy months: race weekends and paddock hospitality, county and state fair events, festivals, farmers markets, dealer and equipment demo days, and campus recruiting. A printed pop-up canopy gives you shade through humid Midwest afternoons and a roof overhead when a thunderstorm rolls across open ground. Weight all four legs, because fairgrounds and paddock lots are hardpack or asphalt where stakes cannot be driven and wind crosses unbroken. Dye-sublimated graphics keep their color through a full season outdoors. Configure a 10×10, 10×15 or 10×20 with printed half-walls for instant online pricing.',
        links: [{ label: 'Custom canopy tents', to: '/custom-canopies' }, { label: '10×10 canopy tent', to: '/products/canopy-tent-10x10' }, { label: '10×15 canopy tent', to: '/products/canopy-tent-10x15' }, { label: '10×20 canopy tent', to: '/products/canopy-tent-10x20' }]
      },
      {
