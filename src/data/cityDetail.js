...
export const DISPLAY_SPEC_ROWS = [
  ...
  ['Table cover', 'Wrinkle-resistant polyester', 'Dye sublimation', '4, 6, 8 ft', '6–8 business days (2–3 rush)']
];
...
export const CITY_DETAIL = {
  ...
  'orlando': {
    ...
    overview: [
      ...
      'That mix rewards displays that look polished under bright expo lighting and hold up to Florida humidity. Apex prints the canopies, banner stands, backdrops and table covers to order and delivers them to your Orlando hotel, the OCCC receiving dock or your business address, so your booth is ready when you land.'
    ],
    whyExhibit:
    ...
    faqs: [
      { q: 'Do you ship trade show displays to Orlando?', a: 'Yes. Apex prints every display to order and ships it to Orlando and across Florida — to your I-Drive hotel, the Orange County Convention Center receiving dock, an advance warehouse or a business address. Everything is made to order with a free artwork proof, and production runs 6–8 business days (2–3 with rush) before transit.' },
      { q: 'Do you offer backdrop printing and step & repeat backdrops in Orlando?', a: 'Yes. Both backdrop styles print to order for Orlando exhibitions, association meetings and press events, made to order and shipped to your venue or business address. The graphic is replaceable, so a new campaign reuses the same frame between OCCC shows.' },
  ...
  'chicago': {
    ...
    overview: [
      ...
      'Exhibitors here face big halls and sophisticated audiences, so crisp, well-lit branding matters. Apex prints each piece to order and ships it to your Chicago venue, an advance warehouse or your business address, ready for move-in.'
    ],
    whyExhibit:
  ...
  'atlanta': {
    ...
    overview: [
      ...
      'For exhibitors, that means high-volume audiences and easy fly-in access — and displays that need to look sharp under bright hall lighting and through humid Georgia summers. Apex prints the backdrops, banner stands, table covers and canopies to order and ships them to your Atlanta venue or business address.'
    ],
    whyExhibit:
    ...
    faqs: [
      ...
      { q: 'Do you offer backdrop printing and step & repeat backdrops in Atlanta?', a: 'Yes. We print step & repeat backdrops and seamless tension-fabric walls for Atlanta trade shows, premieres and corporate events, shipped to your venue or business address. Atlanta\'s film and entertainment sector orders a lot of media walls, and the replaceable graphic means one frame serves many productions.' },
  ...
  'dallas': {
    ...
    overview: [
      ...
      'Texas heat and bright halls call for durable, high-contrast branding. Apex prints every canopy, banner stand, backdrop and table cover to order and sends it to your Dallas venue, an advance warehouse or your business address, ready for setup.'
    ],
    whyExhibit:
    ...
    faqs: [
      { q: 'Do you ship trade show displays to Dallas?', a: 'Yes. Apex is online-only and ships custom-printed displays to Dallas–Fort Worth and across Texas — to the Kay Bailey Hutchison Convention Center, the Dallas Market Center, the Irving Convention Center or your business address. Everything is printed to order with a free artwork proof; production runs 6–8 business days (2–3 with rush) before transit.' },
      { q: 'Do you offer backdrop printing and step & repeat backdrops in Dallas?', a: 'Yes — step & repeat backdrops and tension-fabric display walls are printed to order for Dallas exhibitions, market weeks and corporate events, shipped to your venue or business address. The printed graphic is replaceable on the same frame, so a wholesale showroom can refresh its look between markets without rebuying hardware.' },
      ...
      { q: 'Which displays suit the convention center\'s large halls?', a: 'Fabric backdrops, retractable banner stands and printed table covers suit an indoor booth in the downtown halls best: they read across a wide contiguous floor and set up tool-free with no installation labor. Put a step & repeat or tension-fabric wall behind you, retractable banners where the aisle turns, and a fitted cover on the demo table.' },
    ...
    productSections: [
      ...
      },
      {
        ...
        body: 'North Texas heat is the reason canopies get ordered in Dallas. Summer afternoons run past 100°F with hard, direct sun, and an unshaded outdoor booth loses visitors by noon — at equipment demos, ranch and industrial expos, festivals, tailgates and corporate campus events. A printed pop-up canopy fixes that with shade plus a branded footprint visible across a lot. Weight all four legs: paved surfaces rule out stakes, and severe-storm season sends gusts through well ahead of the rain. Dye-sublimated graphics stay saturated under Texas UV. Pick a 10×10, 10×15 or 10×20 footprint, add printed half-walls, and see the price online.',
        links: [{ label: 'Custom canopy tents', to: '/custom-canopies' }, { label: '10×10 canopy tent', to: '/products/canopy-tent-10x10' }, { label: '10×15 canopy tent', to: '/products/canopy-tent-10x15' }, { label: '10×20 canopy tent', to: '/products/canopy-tent-10x20' }]
      },
      {
  ...
  'new-york': {
    ...
    faqs: [
      ...
      { q: 'What\'s the best way to get a display into the Javits Center?', a: 'Ship to the show\'s advance warehouse when one is offered. The Javits Center uses union labor and an official freight contractor, and West Side loading windows are tightly scheduled, so pre-delivered freight avoids move-in morning entirely. The alternative is a hand-carried kit: it ships to your hotel or office and goes up without a crew.' },
      { q: 'Which displays are best for expensive, space-tight NYC shows?', a: 'Portable, crew-free displays for an indoor booth: fabric backdrops, retractable banner stands and printed table covers. They deliver full-height branding while keeping labor, drayage and freight costs down, and they fit through a hotel door, into a taxi trunk, or up a Manhattan service elevator without a crate or a forklift.' },
  ...
  'houston': {
    ...
    overview: [
      ...
      'For exhibitors, that means technical, high-value audiences and displays that need to look sharp in cavernous halls. Apex prints canopies, banner stands, backdrops and table covers to order and routes them to your Houston venue, an advance warehouse or your business address, ready for setup.'
    ],
    whyExhibit:
    ...
    planning:
      'Houston splits across two very different campuses, so confirm which one your show uses before booking anything. The George R. Brown sits downtown with an official contractor, an advance warehouse and standard dock scheduling. NRG Park handles far heavier freight — vehicles, rigs and equipment — with union labor for installation at its biggest events and longer staging queues on move-in day. Budget material handling for both. Portable displays skip most of it, arriving as a case or tube. Production is 6–8 business days after proof approval (2–3 with rush) before transit, so plan artwork approval, production and shipping as separate legs.',
    bestDisplays:
    ...
    faqs: [
      ...
      { q: 'Do canopies handle Houston heat and storms?', a: 'Yes. A printed canopy gives shade through humid Gulf Coast heat and overhead cover when a downpour arrives, which happens quickly here. Weight all four legs for the gusts that lead a storm in, and keep electronics off the ground where water pools on paved activation space.' },
      ...
      { q: 'Which displays suit Houston\'s large halls?', a: 'Fabric backdrops, retractable banner stands and printed table covers suit an indoor GRB or NRG Center booth best: they read from a distance across very large exhibit floors, set up tool-free, and avoid installation labor. Start with a tension-fabric or step & repeat wall for height, add retractable banners along the aisle, and cover the table with a fitted throw.' },
  ...
  'los-angeles': {
    ...
    overview: [
      ...
      'Exhibiting here rewards displays that look modern under bright lighting and hold up outdoors in the SoCal sun. Apex prints the whole kit to order — canopies, banner stands, backdrops, table covers — and ships it to your LA venue, hotel or business address, ready to set up.'
    ],
    whyExhibit:
    ...
    faqs: [
      ...
      { q: 'Which displays suit LA\'s media-savvy audiences?', a: 'Clean, photogenic pieces for an indoor booth: a seamless tension-fabric backdrop or a step & repeat wall, retractable banner stands with minimal copy, and a crisp fitted table cover. LA audiences photograph everything, so a display that looks intentional in a phone camera frame does more work than one crowded with text.' },
  ...
  'miami': {
    ...
    faqs: [
      ...
      { q: 'What displays suit an art fair or design event in Miami?', a: 'Restrained ones. Indoors, a seamless tension-fabric wall or a clean step & repeat, a single retractable banner stand, and a fitted table cover in one flat brand color let the work stay the focus, while still identifying the gallery, brand or sponsor clearly in photographs.' },
    ...
    productSections: [
      ...
      },
      {
        ...
        body: 'Miami runs outdoors year-round: beachfront activations, pool decks, marina and boat-show docks, art-week satellite fairs, festivals, farmers markets, community events and sampling programs. A printed pop-up canopy gives you shade against strong subtropical sun and a roof over the booth for the rain that blows through most afternoons in summer. Wind is the constant design factor — a steady sea breeze plus no ability to stake on pavement or packed sand means a full weight bag on every leg, and half-walls only where they will not catch the breeze. Choose a 10×10, 10×15 or 10×20 with printed walls and price it online in a couple of clicks.',
        links: [{ label: 'Custom canopy tents', to: '/custom-canopies' }, { label: '10×10 canopy tent', to: '/products/canopy-tent-10x10' }, { label: '10×15 canopy tent', to: '/products/canopy-tent-10x15' }, { label: '10×20 canopy tent', to: '/products/canopy-tent-10x20' }]
      },
      {
  ...
  'boston': {
    ...
    answer:
      'Boston is New England’s convention hub and a global life-sciences center, host to major biotech, medical and seafood shows at the Boston Convention & Exhibition Center. Apex prints custom trade show displays for Boston exhibitions, symposia and events and ships them over.',
    overview: [
    ...
    planning:
      'Seaport logistics dominate a Boston move-in. The Menino Convention and Exhibition Center (the former BCEC) uses an official freight contractor with an advance warehouse and union labor at larger shows, and the district street grid and bridge access back up badly around move-in, so a missed delivery slot is hard to recover. Winter storms add another layer. Portable displays avoid most of this: a case walks over from a Seaport hotel in ten minutes. Production is 6–8 business days after proof approval (2–3 with rush) before transit, so build in weather margin for a January or February show.',
    bestDisplays:
    ...
    faqs: [
      ...
      { q: 'Which displays suit a technical Boston audience?', a: 'Understated, well-made pieces for an indoor booth: a seamless tension-fabric backdrop that can carry a diagram or data at full height, retractable banner stands with specific rather than promotional copy, and a fitted table cover for reprints and demos. Boston\'s research and clinical audiences read closely, so precision reads better than volume.' },
  ...
  'denver': {
    ...
    planning:
      'Two Denver-specific things to plan around. The Colorado Convention Center finished its expansion in 2024, so confirm which hall and which entrance your show uses rather than relying on an old floor plan. And winter freight into Denver crosses mountain and plains corridors that close in a storm, so a shipment arriving the day before move-in has no margin at all. Larger shows use an official contractor with an advance warehouse and union labor, so budget material handling. Production is 6–8 business days after proof approval (2–3 with rush) before transit — add transit margin from November through March.',
    bestDisplays:
    ...
    faqs: [
      ...
      { q: 'What displays suit an outdoor-industry or natural-products show?', a: 'Fabric-forward pieces for an indoor booth, at home next to gear: a tension-fabric backdrop with a large environmental image, retractable banner stands for product lines, a branded table cover for sampling, and a canopy if the brand also runs demo days or festival footprints outdoors through the summer.' },
    ...
    productSections: [
      ...
      },
      {
        ...
        body: 'Denver brands live outdoors, and a printed canopy is the piece that gets used most: demo days, trailhead activations, festivals, farmers markets, race expos, stock-show grounds and campus events. Altitude is what makes the shade genuinely valuable — UV at a mile up is harsh, and a covered booth keeps visitors comfortable far longer. It also cuts both ways: weather turns quickly here, so a printed top overhead earns its place when an afternoon storm or shoulder-season snow arrives. Weight all four legs for gusts on paved ground. Configure a 10×10, 10×15 or 10×20 with printed walls online.',
        links: [{ label: 'Custom canopy tents', to: '/custom-canopies' }, { label: '10×10 canopy tent', to: '/products/canopy-tent-10x10' }, { label: '10×15 canopy tent', to: '/products/canopy-tent-10x15' }, { label: '10×20 canopy tent', to: '/products/canopy-tent-10x20' }]
      },
      {
  ...
  'new-orleans': {
    ...
    answer:
      'New Orleans hosts a heavy calendar of medical, energy and food shows at the Ernest N. Morial Convention Center beside the French Quarter. Apex prints custom trade show and exhibition displays and ships them into New Orleans.',
    overview: [
    ...
    faqs: [
      ...
      { q: 'Do you offer backdrop printing and step & repeat backdrops in New Orleans?', a: 'Yes — backdrop printing is a core line, and we make step & repeat backdrops and tension-fabric walls for New Orleans conventions, receptions and press events, shipped to your venue or business address. Both use a replaceable graphic over a reusable frame, which suits associations that return to the Morial Center year after year.' },
      ...
      { q: 'Do canopies handle New Orleans heat and rain?', a: 'Yes. Shade is the main draw in Gulf Coast humidity, and the printed top gives you cover overhead when the heavy rain arrives suddenly here. Weight all four legs — storms lead with wind, the ground is paved almost everywhere downtown, and water pools quickly, so keep cases and electronics off the deck.' },
      ...
      { q: 'Which displays suit the Morial Center\'s huge halls?', a: 'Fabric backdrops, retractable banner stands and printed table covers suit an indoor booth on roughly 1.1 million square feet of contiguous exhibit space: they read from a distance, set up tool-free and avoid installation labor. Anchor with a tension-fabric or step & repeat wall, mark the aisle with retractable banners, and finish the table with a fitted cover.' },
    ...
    productSections: [
      ...
      },
      {
        ...
        body: 'Outdoor branding is constant in New Orleans — festival grounds, riverfront events, parade-season activations, courtyard receptions, second-line gatherings and campus days. A printed pop-up canopy is the practical answer to a climate that delivers heat, humidity and sudden heavy rain in the same afternoon: shade keeps people at your booth, and a printed top puts a roof over the giveaways. Weight every leg, because storms lead with gusts and downtown surfaces are paved. Dye-sublimated graphics resist UV and Gulf humidity without lifting. Set the size at 10×10, 10×15 or 10×20, add printed half-walls, and one canopy covers the season.',
        links: [{ label: 'Custom canopy tents', to: '/custom-canopies' }, { label: '10×10 canopy tent', to: '/products/canopy-tent-10x10' }, { label: '10×15 canopy tent', to: '/products/canopy-tent-10x15' }, { label: '10×20 canopy tent', to: '/products/canopy-tent-10x20' }]
      },
      {
  ...
  'phoenix': {
    ...
    answer:
      'Phoenix’s downtown convention center hosts technology, healthcare and a fast-growing semiconductor industry. Apex prints custom trade show displays for Valley exhibitions and events and ships them to Phoenix.',
    overview: [
      ...
      'The extreme desert heat and intense UV make durable, fade-resistant displays essential, and monsoon-season storms add a wind-and-dust factor for outdoor activations. Apex prints canopies, banner stands, backdrops and table covers to order and routes them to your Phoenix venue or business address.'
    ],
    whyExhibit:
    ...
    faqs: [
      { q: 'Do you ship trade show displays to Phoenix?', a: 'Yes. Apex is online-only and ships custom-printed displays to Phoenix and across Arizona — to the Phoenix Convention Center, a Valley resort venue, a stadium expo or your business address. Everything is printed to order with a free artwork proof, and production runs 6–8 business days (2–3 with rush) before transit.' },
      { q: 'Do you offer backdrop printing and step & repeat backdrops in Phoenix?', a: 'Yes — step & repeat backdrops and tension-fabric display walls are printed to order for Phoenix conventions, resort conferences and corporate events, shipped to your venue or business address. Both use a replaceable graphic over a reusable aluminum frame, so a returning exhibitor updates the artwork and keeps the hardware.' },
      ...
      { q: 'What displays suit an outdoor event in Phoenix summer?', a: 'Indoors a fabric backdrop and banner stands are enough, but outdoors a canopy with weighted legs is the base requirement, because unshaded booths are not workable in extreme heat. Add a fabric backdrop under the canopy for branding, keep banner stands inside the shade line so bases stay cooler, and choose a table cover in a lighter tone.' },
  ...
  'san-diego': {
    ...
    overview: [
      ...
      'The mild coastal climate makes outdoor and waterfront activations practical much of the year, so branding needs to look good in the sun and hold up to a steady sea breeze. Apex prints the whole kit to order — canopies, banner stands, backdrops and table covers — and ships it to your San Diego venue or business address.'
    ],
    whyExhibit:
    ...
    planning:
      'The San Diego Convention Center sits on the bayfront with Gaslamp hotels a short walk away and the airport about ten minutes out, which makes checked-bag display kits genuinely practical here. Larger shows still use an official freight contractor with an advance warehouse and union labor, so budget material handling and confirm your receiving window. During citywide events the surrounding streets close to staged traffic, so check the move-in route as well as the dock. Production is 6–8 business days after proof approval (2–3 with rush) before transit, so count back from move-in across artwork approval, production and transit.',
    bestDisplays:
      'On the bayfront exhibit floor, a tension-fabric backdrop or step & repeat carries the brand, retractable banners hold the aisle, and a fitted cover finishes the table. For bayfront and outdoor activations, a weighted canopy adds shade and branding. For hotel suites and pop-ups, lightweight X-stand and tabletop banners set up fast.',
    faqs: [
      { q: 'Do you ship trade show displays to San Diego?', a: 'Yes. Apex prints every display to order and ships it to San Diego and across Southern California — to the San Diego Convention Center, a Mission Valley hotel venue, a Gaslamp Quarter property or your business address. Everything is made to order with a free artwork proof, and production runs 6–8 business days (2–3 with rush) before transit.' },
      { q: 'Do you offer backdrop printing and step & repeat backdrops in San Diego?', a: 'Yes. Both backdrop styles print to order for San Diego conventions, biotech symposia and consumer events, shipped to your venue or business address. A replaceable graphic on a reusable frame works well for research groups and companies presenting at several conferences a year.' },
    ...
    productSections: [
      ...
      },
      {
        ...
        body: 'San Diego weather makes outdoor branding a year-round option rather than a summer one, which is why canopies get so much use here: bayfront activations beside the convention center, beach and pier events, farmers markets, military and community days, and the outdoor programming that surrounds big downtown conventions. A printed pop-up canopy gives shade against consistent sun and a branded footprint people spot from across an open space. Weight all four legs for the afternoon sea breeze, since bayfront and beach setups sit on pavement or packed sand. Choose 10×10, 10×15 or 10×20, add printed half-walls, and the price comes back instantly.',
        links: [{ label: 'Custom canopy tents', to: '/custom-canopies' }, { label: '10×10 canopy tent', to: '/products/canopy-tent-10x10' }, { label: '10×15 canopy tent', to: '/products/canopy-tent-10x15' }, { label: '10×20 canopy tent', to: '/products/canopy-tent-10x20' }]
      },
      {
  ...
  'washington-dc': {
    ...
    planning:
      'Two things shape a D.C. move-in. First, the Walter E. Washington Convention Center runs an official freight contractor with union labor and an advance warehouse, so material handling belongs in the budget. Second, many association exhibitors ship to a downtown hotel or an office mailroom instead, and those add a receiving step of their own, sometimes a full day, before anything reaches you. Metro-accessible venues make a hand-carried case realistic. Production is 6–8 business days after proof approval (2–3 with rush) before transit, so leave room for artwork approval, production, transit and that last handoff.',
    bestDisplays:
    ...
    faqs: [
      ...
      { q: 'Do you offer backdrop printing and step & repeat backdrops in Washington?', a: 'Yes. Both backdrop styles print to order for D.C. association meetings, policy briefings, awards programs and press events, shipped to your venue or business address. Both take a replaceable graphic over a reusable frame, which suits organizations running an annual meeting each year.' },
      ...
      { q: 'Which displays suit a credential-conscious D.C. audience?', a: 'Understated, well-finished pieces for an indoor booth: a seamless tension-fabric wall, retractable banner stands with factual copy rather than sales language, and a fitted table cover. Association, agency and policy audiences treat a booth as a signal of seriousness, so accurate typography and restraint outperform bright promotional graphics.' },
  ...
  'san-francisco': {
    ...
    answer:
      'San Francisco is a global technology and life-sciences convention hub, hosting Dreamforce, the Game Developers Conference and the RSA Conference at the Moscone Center in SoMa. Apex prints custom trade show displays to order and ships them to San Francisco.',
    overview: [
    ...
    faqs: [
      ...
      { q: 'Do you offer backdrop printing and step & repeat backdrops in San Francisco?', a: 'Yes. We print step & repeat backdrops and seamless tension-fabric walls for San Francisco conferences, launch events and demo days, shipped to your venue or business address. Both take a replaceable graphic on a reusable frame, which suits companies that exhibit at several Moscone conferences each year.' },
  ...
  'seattle': {
    ...
    faqs: [
      ...
      { q: 'Do canopy tents work for Seattle outdoor events?', a: 'Yes. A printed pop-up canopy suits Seattle waterfront activations, street festivals and markets: the printed top gives you cover overhead through the wet Northwest season, and weighting every leg handles the breezes that come off Puget Sound. Add printed half-walls for shade and a backdrop while keeping the front open to visitors.' },
  ...
  'nashville': {
    ...
    planning:
      'Decide first which Nashville venue you are shipping to, because they behave differently: the Music City Center sits downtown with an official freight contractor, an advance warehouse and union labor at larger shows, while Gaylord Opryland is a separate resort campus several miles out with its own receiving rules and storage limits. Budget material handling either way and confirm the receiving window in writing. Portable displays sidestep most of it — a case or tube walks in from a downtown hotel. Production is 6–8 business days after proof approval (2–3 with rush) before transit, so count back from move-in across artwork approval, production and transit.',
    bestDisplays:
    ...
    faqs: [
      ...
      { q: 'Do canopies handle Nashville summer storms?', a: 'Yes. A printed canopy gives shade through humid Tennessee afternoons and overhead cover when a pop-up thunderstorm arrives, which is common from late spring through summer. Weight all four legs for the gust front that precedes the rain, especially on the paved lots used for downtown activations.' },
      { q: 'Which displays work best inside the Music City Center?', a: 'Fabric backdrops, retractable banner stands and printed table covers work best inside the Music City Center, the indoor booth kit for most exhibitors: they are portable, set up tool-free and need no installation labor. Back the booth with a step & repeat or tension-fabric wall, flank the aisle with retractable banners, and finish the meeting table with a fitted cover.' },
    ...
    productSections: [
      {
        ...
        body: 'Nashville puts two audiences in front of you — healthcare executives at Music City Center conventions and the music, hospitality and publishing worlds that fill the rest of the calendar — and a coordinated set of exhibition displays works for both. A step & repeat or tension-fabric backdrop builds the brand wall, retractable banner stands carry a single clear message at the aisle, a printed table cover finishes the demo or signing table, and a canopy covers the outdoor activations that downtown and Broadway-adjacent events invite. Buying these custom trade show displays together keeps colors matched. It all prints to order, packs down into a case or tube, and ships to Nashville.',
        links: [{ label: 'Shop all trade show displays', to: '/trade-show-displays' }, { label: 'Trade show booth packages', to: '/trade-show-booth-packages' }]
      },
      {
        h2: 'Custom Canopy Tents in Nashville',
        body: 'Nashville does a lot of business outdoors: festival footprints, downtown activations, tailgates, fairground events, brewery and distillery days, and summer sampling programs. A printed pop-up canopy is what makes those spaces yours, and in Tennessee it does double duty — shade through humid afternoons, then a roof overhead when a thunderstorm builds with little warning. Weight all four legs, because those storms lead with wind and most activation sites are paved. Dye-sublimated graphics resist both UV and humidity, staying saturated across a full festival season. Specify 10×10, 10×15 or 10×20 with printed half-walls and the configurator prices it as you go.',
        links: [{ label: 'Custom canopy tents', to: '/custom-canopies' }, { label: '10×10 canopy tent', to: '/products/canopy-tent-10x10' }, { label: '10×15 canopy tent', to: '/products/canopy-tent-10x15' }, { label: '10×20 canopy tent', to: '/products/canopy-tent-10x20' }]
      },
      {
  ...
  'indianapolis': {
    ...
    overview: [
      ...
      'Exhibitors reach manufacturing, life-sciences, motorsports and sports-industry buyers in a compact, easy-to-navigate downtown. Apex prints every canopy, banner stand, backdrop and table cover to order and sends it to your Indianapolis hotel, the convention center dock or a business address.'
    ],
    whyExhibit:
    ...
    planning:
      'Indianapolis is built for exhibitors who carry their own gear: the skywalk network connects the Indiana Convention Center to thousands of hotel rooms, so a banner case or backdrop tube goes hall-to-room without ever going outside, which matters in January. Larger shows use an official freight contractor and union labor with an advance warehouse before move-in, and events that spill into Lucas Oil Stadium share dock access, so confirm which building receives your shipment. Production is 6–8 business days after proof approval (2–3 with rush) before transit, so work backwards from move-in across artwork approval, production and transit.',
    bestDisplays:
    ...
    faqs: [
      { q: 'Do you ship trade show displays to Indianapolis?', a: 'Yes. Apex is online-only and ships custom-printed displays to Indianapolis and across Indiana — to the Indiana Convention Center, Lucas Oil Stadium, the State Fairgrounds or your business address. Everything is printed to order with a free artwork proof, and production runs 6–8 business days (2–3 with rush) before transit.' },
      { q: 'Do you offer backdrop printing and step & repeat backdrops in Indianapolis?', a: 'Yes. We print step & repeat backdrops and seamless tension-fabric walls for Indianapolis conventions, racing-industry events and association meetings, shipped to your venue or business address. The graphic is replaceable on a reusable frame, so a team or exhibitor updates artwork between seasons and keeps the hardware.' },
    ...
    productSections: [
      ...
      },
      {
        ...
        body: 'Indianapolis packs its outdoor season into a few busy months: race weekends and paddock hospitality, county and state fair events, festivals, farmers markets, dealer and equipment demo days, and campus recruiting. A printed pop-up canopy gives you shade through humid Midwest afternoons and a roof overhead when a thunderstorm rolls across open ground. Weight all four legs, because fairgrounds and paddock lots are hardpack or asphalt where stakes cannot be driven and wind crosses unbroken. Dye-sublimated graphics keep their color through a full season outdoors. Build it at 10×10, 10×15 or 10×20 with printed half-walls and price it in the configurator.',
        links: [{ label: 'Custom canopy tents', to: '/custom-canopies' }, { label: '10×10 canopy tent', to: '/products/canopy-tent-10x10' }, { label: '10×15 canopy tent', to: '/products/canopy-tent-10x15' }, { label: '10×20 canopy tent', to: '/products/canopy-tent-10x20' }]
      },
      {
  ...
  'charlotte': {
    ...
    overview: [
      ...
      'Exhibitors reach a business-heavy, professionally minded audience in a compact, walkable uptown. Apex prints the canopies, banner stands, backdrops and table covers to order and ships them straight to your Charlotte hotel, the convention center dock or a business address.'
    ],
    whyExhibit:
    ...
    planning:
      'Charlotte is one of the easier move-ins on this list: the convention center sits in uptown within walking distance of most headquarter hotels and is linked to the NASCAR Hall of Fame, so a case or tube often travels by hand rather than by freight. Larger shows still run through an official contractor with an advance warehouse and union labor, so budget material handling and confirm your receiving window. Parking decks fill early on move-in morning, which matters if you are unloading yourself. Production is 6–8 business days after proof approval (2–3 with rush) before transit — plan the artwork approval, production and shipping legs separately.',
    bestDisplays:
      'Exhibition displays here are judged on finish. On the bayfront floor, a tension-fabric backdrop or step & repeat carries the brand, retractable banners work the aisle, and a fitted cover finishes the demo table. For outdoor and speedway-adjacent activations, a weighted canopy adds a branded footprint with shade and rain cover. For hotel meetings and uptown side-events, lightweight X-stand and tabletop banners set up fast.',
    faqs: [
      { q: 'Do you ship trade show displays to Charlotte?', a: 'Yes. Apex prints every display to order and ships it to Charlotte and across North Carolina — to the Charlotte Convention Center, the NASCAR Hall of Fame, an uptown hotel or your business address. Everything is made to order with a free artwork proof, and production runs 6–8 business days (2–3 with rush) before transit.' },
      { q: 'Do you offer backdrop printing and step & repeat backdrops in Charlotte?', a: 'Yes — step & repeat backdrops and tension-fabric display walls are printed to order for Charlotte exhibitions, banking and energy conferences and racing-industry programming, shipped to your venue or business address. Both use a replaceable graphic over a reusable aluminum frame, so the frame outlasts any single campaign.' },
      ...
      { q: 'Do canopies handle Charlotte summer storms?', a: 'Yes. A printed canopy gives shade through humid Piedmont afternoons and overhead cover when a pop-up thunderstorm builds, which is routine from late spring into summer. Weight all four legs for the gust front that arrives first, especially on the paved lots used for uptown and speedway-adjacent activations.' },
