...
export const CITY_DETAIL = {
  ...
  'seattle': {
    ...
    faqs: [
      ...
      { q: 'Which displays work best inside the Seattle Convention Center?', a: 'Inside the hall, a tension-fabric backdrop or step & repeat anchors the booth wall, retractable banner stands carry your headline at the aisle, and a fitted table cover finishes the demo or registration table. X-stand and tabletop banners suit side meetings. Save canopies for outdoor and waterfront activations rather than the convention floor.' },
