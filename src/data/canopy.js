...
export const SIZES = [
  {
    ...
    blurb: 'The standard vendor booth, and the size most event organizers allocate by default.',
    guide: {
...
export const SOLUTIONS = [
  ...
  },
  {
    ...
    guide: {
      metaDescription:
        'Custom printed trade show canopy tents — full-color branding to match your indoor booth, printed back walls, and 10×20 double-booth options.',
      intro:
        'Outdoor expo space has to look as considered as your indoor booth. A printed canopy top, valance and back wall turn open pavement into a branded booth that photographs well and holds its own next to other exhibitors. Color consistency with your indoor graphics matters — dye-sublimation prints hold brand colors cleanly.',
      focus: [
        'Full-color top, valance and back wall for a finished exhibitor backdrop.',
        'Brand colors that match your indoor booth and printed collateral.',
      ...
      care:
        'The frame is heavy-duty aluminum with a pop-up hex design, so it stands square for a multi-day show and travels between events in a wheeled bag. Because the top and walls are dye-sublimated into 600D polyester, the print holds the same brand colors as your indoor graphics and will not crack, peel or fade under sun across a show season. Between shows, spot-clean any marks with mild soap and water and let the fabric dry fully before it goes back in the bag. Outdoors on pavement, anchor every leg with weights — an exhibitor tent catches wind like a sail.'
    }
  },
  {
    slug: 'sports-team-tents',
    title: 'Sports & Tailgate Tents',
    blurb: 'Team colors, shade for the bench, and something findable in a crowded lot.',
    guide: {
      metaDescription:
        'Custom printed sports and tailgate canopy tents — team colors and logo, sideline shade, crowd visibility, and a portable frame for weekly games.',
      intro:
        'Team tents pull double duty: shade for the bench and gear on the sideline, and a landmark supporters can find in a packed tailgate lot. Printed in your team colors with the logo up top, it marks your spot from a distance and travels game to game without fuss.',
      focus: [
        'Team colors and logo on the top and valance for visibility across the field or lot.',
      ...
      walls:
        'Sports setups usually stay open for airflow and access. Add a single back wall in team colors as a backdrop, or half walls to block low sun and wind.',
      care:
        'The aluminum pop-up frame goes up and comes down fast so a couple of parents or players can handle it before and after a game, and it packs into a wheeled bag for the trip home. Team colors and the logo are dye-sublimated into 600D polyester, so they take repeated sun and travel without cracking, peeling or fading through the season. Wipe down mud or drink spills with mild soap and water and let it dry before packing so it does not sit damp. In an open field or tailgate lot, always weight or stake each leg — exposed ground is where tents blow over.'
    }
  },
  {
    ...
    guide: {
      ...
      care:
        'The pop-up aluminum frame sets up and breaks down quickly between events, which matters when you are working a run of markets and festivals, and it packs into a wheeled bag. The valance and walls are dye-sublimated into 600D polyester, so a printed menu stays sharp and color-true and will not crack, peel or fade over a busy season. The fabric wipes down: clean grease or food splashes with mild soap and water and let it dry fully before packing so it does not develop odour or mildew. Anchor every leg with weights outdoors so the tent stays put over a hot service line.'
    }
  },
  {
    ...
    guide: {
      ...
      intro:
        'Churches and schools need a friendly, findable landmark for the events that fill the calendar — registration and welcome desks, fundraisers, sports days and open days. A tent printed with the organization name gives volunteers an obvious base and shade to work under, and it reappears at every event through the year.',
      focus: [
        'Organization name and logo printed on the top and valance as a welcome point.',
      ...
      care:
        'The aluminum pop-up frame is designed for a rotating group of volunteers — it opens accordion-style in a few minutes with no tools and packs into a wheeled bag for storage between events. The organization name and logo are dye-sublimated into 600D polyester, so one tent looks the same at every fundraiser and open day through the year without cracking, peeling or fading. Spot-clean with mild soap and water and let the fabric dry fully before it goes back in the bag so it stores clean. At outdoor events, weight or stake each leg so it stays safe around families and children.'
    }
  },
  {
    slug: 'job-site-tents',
    ...
    guide: {
      ...
      care:
        'The frame is heavy-duty aluminum built for daily setup and teardown on rough ground, and it folds into a wheeled bag to move between sites. The company name and logo are dye-sublimated into 600D polyester, so the branding survives sun, dust and repeated handling without cracking, peeling or fading. Hose off or wipe down site dirt with mild soap and water and let it dry fully before packing so it does not sit damp in the bag. On exposed or windy ground, always anchor every leg with weights or stakes — on an active site an unsecured tent is a hazard.'
    }
  }
];
